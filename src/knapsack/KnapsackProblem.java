...
public class KnapsackProblem {
	...
	private ArrayList<Sack> bestSolution;

	public KnapsackProblem(Sack[] bags, int totalWeight) {
		this.bags = bags;
	...
	public void solve() {
		...
		if (bestSolution == null) {
			bestSolution = new ArrayList<Sack>();
		}
	 ...
	 * 
	 */
	public ArrayList<Sack> getBestSolution() {
		return bestSolution;
	}
